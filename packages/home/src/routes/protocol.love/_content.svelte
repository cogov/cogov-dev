<div class="protocolLoveContent">
	...
	<p class="protocolLoveContent__body">
		...
		<br/><br/>
		Protocol.Love is a proposal to imbue <a
		href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
		target="_blank">Loving Kindness</a> into socioeconomic systems. It does so by providing standards through which organizations can embody their commitment to <a
		href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
		target="_blank">Vulnerable Transparency</a>.
		Ultimately, by having large amounts of data shared on distributed ledgers with a standard protocol for <a
		href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
		target="_blank">Vulnerable Transparency</a>, we will be able to algorithmically identify Loving and Kind behavior– which is inherently anti-rivalrous, and omni-win.
		<br><br>
		Read the background here: <a target="_blank"
																 href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9">A Digital Protocol for Scaling Loving Kindness</a>
		<br><br>
...
<br/>
<p class="protocolLoveContent__subtitle">
				In order for a Collective to operate with <a class="removelink underline"
																										 href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
																										 target="_blank">Vulnerable Transparency</a>, what does it need to share?
</p>
<br/><br/>
...
<p class="protocolLoveContent__body">
		...
		<br>
		Protocol.love brings <a
	href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
	target="_blank">Vulnerable Transparency</a> to the establishment of Collectives by proposing what the important things are that anyone ought to be able to discover about the Collective. This document is a combination of something like articles of incorporation, combined with something like a lean business plan.<br/>
		<br/>
		Read more: <a target="_blank"
									href="https://docs.google.com/document/d/1Rh02JzKhQ5sA6V500cQm74kb-jd4VcS8bskDDUsBpQA">Collective Foundational Document Template</a>
		<br><br>
...
<br>
		...
		<br>
		Protocol.love enhances <a
	href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
	target="_blank">Vulnerable Transparency</a> in decision making by naming the 3 fundamental steps that happen in any group decision making process, and providing the means to share these processes in a way that deeply informs interested parties.
		<br><br>
