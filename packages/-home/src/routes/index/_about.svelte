<div class="homeAbout" id="homeAbout">
	<div class="homeAbout__header">
		...
		<h3 class="homeAbout__body">
			...
			<a
				href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
				target="_blank"
			>Vulnerable Transparency</a>, which is also omini-win and anti-rivalrous.
			...
			<a href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
				 target="_blank"
	...
	<div class="homeAbout__items">
		...
		<div class="homeAbout__item">
			<iframe class="homeAbout__item--video" src="https://www.youtube.com/embed/2FJL3ibnZlY" frameborder="0"
