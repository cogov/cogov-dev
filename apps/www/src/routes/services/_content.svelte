...
<br><br>
For too long, we have lived in a global culture of domination, where there is a constant underlying struggle to identify who has power over who. So many people have been in the habit of giving away their power in subtle ways, and then claiming victimhood. So many others have been in the habit of taking power in subtle ways, then using that power for their own personal gain, often at the expense of others.
<br><br>
The <a href="/vision" target="blank" class="addlink">core principles</a> that have been identlified in creating the <a
		href="/protocol.love" target="blank" class="addlink">CoGov Protocol</a> create a communications framework that avoid these pitfalls. While digital tools are also in the works, during this critical time, we are very interested in using the operational principles “on paper”, so to speak. The CoGov staff would love nothing more than to work with your organization now to design a <a
