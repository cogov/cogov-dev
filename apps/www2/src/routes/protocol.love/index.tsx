...
export default function C_protocol_love() {
	return [
		<Style/>,
		<Head>
			<Title>Protocol.Love: Fostering the emergence of a socioeconomic system infused with Loving Kindness</Title>
		</Head>,
		...
		return [
			...
			<div class="protocolLoveHeader page-header">
				...
				<p class="protocolLoveHeader__subtitle">
					...
					target="_blank" class="removelink" style="text-decoration: underline">Loving Kindness</a>
						for organizations who choose a commitment to <a
					href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
					target="_blank" class="removelink" style="text-decoration: underline">Vulnerable Transparency</a>.
				</p>
			</div>
		]
	}
			...
			<div class="protocolLoveContent page-body">
				...
				<p class="protocolLoveContent__body">
					...
					<a
						...
						target="_blank"
					>Vulnerable Transparency</a>,
					we will be able to algorithmically identify Loving and Kind behavior –
				...
				<p class="protocolLoveContent__body">
					...
					to SEE the CURRENT in the flows (holopticism) of nature at all levels,
					we can better mimic those flows in sustainable and regenerative ways in our human systems.
					Therefore, we believe it is appropriate to use the word currency, or current-see,
					as a representation of our ability to notice, record, and better synchronize our activities with those flows,
				...
				<p class="protocolLoveContent__body">
					...
					a collective is essentially synonymous with a DAO (Distributed Autonomous Organization),
					but without any associations with older modalities like “blockchain”
				...
				<p class="protocolLoveContent__body">
					...
					href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
					target="_blank">Vulnerable Transparency</a> is always a choice– a choice that takes extra effort. CoGov does not suggest that there should be any punitive approach or attempt to enforce <a
					href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
					target="_blank">Vulnerable Transparency</a>. The fact is, as more and more data flows into ledgers, we will have the opportunity to test the hypothesis that resistance to transparency is inherently rivalrous behavior. But this is certainly not a given. There are plenty of reasons that a person or group might not make the extra effort to adhere to <a
					href="https://medium.com/@rayzer42/cogov-presents-a-digital-protocol-for-scaling-loving-kindness-1da6605f88d9"
					target="_blank">Vulnerable Transparency</a>.<br/>
					<br/>
				...
				<p class="protocolLoveContent__body">
					...
					<br/><br/>
					<b>Conversation</b> happens all the time.
					Sometimes conversations start to coalesce into something more tangible.
					As tangibility increases, conversations become more focused around a particular mission or vision.
					As the group enters into <b>Interaction</b>,
					participants begin discussing the ways they are aligned and how they could contribute towards it.
					This is the time to open up the Collective Foundational Document (CFD) Template,
					and begin working on it as a group.
					Using the CFD Template, the group will see if they can align on how they wish
					to <b>Transact</b> with each other.
				...
				<p class="protocolLoveContent__body">
					...
					<a
						...
						target="_blank"
					>Vulnerable Transparency</a>
					by sharing flows around who holds the value of an asset or set of assets (Game A “ownership).
					...
					an Equity Currency is a representation of a portion of value of an asset, or a set of assets.
					The value of a unit of an Equity Currency can be estimated by looking at the total value of the asset(s)
					that back any particular type of Equity Currency, and dividing by the total number of units
					...
					Start with the assumption that it is a Fiat Currency.
					If the currency represents an ownership in an asset, it should be an Equity Currency instead.
					If the currency represents power in decision making, it should be an Influence Currency instead.
					...
					<a
						...
						target="_blank"
					>Vulnerable Transparency</a>
					in decision making by naming the 3 fundamental steps that happen in any group decision making process,
					and providing the means to share these processes in a way that deeply informs interested parties.
					<br/><br/>
					First, there is a proposal made (instantiated). Second, the proposal is discussed (Iterated).
					Third, the proposal is resolved. Protocol.love provides a standard means
					...
					<a
						target="_blank"
						href="https://docs.google.com/document/d/1rAtv9VT68X2BvsZRq_4Hf2nT3aqJopCEFsSlzbn2uEw"
